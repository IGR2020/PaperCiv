...
async def main():
    ...
    play_button = Button((window_width - button_size*button_scale, 0), assets["Play"], button_scale)

    username = "main"

    # loading world data / creating new world
    file = open("Civ Data/main.pkl", "rb")
    ...
    close_button = Button((play_button.x-button_size*button_scale, 0), assets["Close"], button_scale)
            ...
            if event.type == pg.MOUSEBUTTONDOWN:
                ...
                for i, button in enumerate(buttons):
                    ...
                    if play_button.clicked():
                        ...
                        if is_paused:
                            play_button = Button((window_width - button_size*button_scale, 0), assets["Pause"], button_scale)
                        else:
                            play_button = Button((window_width - button_size*button_scale, 0), assets["Play"], button_scale)
                        continue
